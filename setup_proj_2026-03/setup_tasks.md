...
- Kitty — focused vs unfocused window differentiation (decision: darker background on focused window, unfocused window, or another approach?)
...
- ~~Check if Ranger should open Neovim or another tool~~ — done; Ranger opens nvim for text files and scripts
...
- Populate `~/dotfiles/keybindings.md` with keybindings across all tools
...
- Claude Code — install
- Claude Code — configure and test
- Ranger — install
- Ranger — configure
